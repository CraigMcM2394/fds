...
INTEGER, ALLOCATABLE, DIMENSION(:)   :: LU_GSTA, LU_GSTH  ! logical unit for GeniSTELA output
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:)   :: FN_GSTA, FN_GSTH ! file name for GeniSTELA output
